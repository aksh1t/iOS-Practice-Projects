README for iOS-Practice-Projects

This Repository contains projects which I made while learning iOS (with the exception of ThreadingTestApp, which I downloaded from a blog to see a working example for Multithreading). These Projects mostly contain basic stuff, which have been summarised below. Note that some of the projects might not display correctly with iOS 7 because they have been made with iOS 5 and Xcode 4.6.
