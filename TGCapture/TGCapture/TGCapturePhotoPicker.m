...
- (TGCapturePhotoPicker *)initWithTitle:(NSString *)title andMessage:(NSString *)message{
    self = [self initWithNibName:@"TGCapturePhotoPicker" bundle:nil];
    if(self){
        canceled = NO;
    ...
    [UIView animateWithDuration:0.1 delay:0.0
                     ...
                     animations:^{
                         ...
                         [UIView animateWithDuration:0.3 animations:^{
                             ...
                             [delegate tgCapturePhotoPickerReturnedData:nil];
                         }];
                     }];
}
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
    ...
    if(canceled) [delegate tgCapturePhotoPickerReturnedData:nil];
    else [delegate tgCapturePhotoPickerReturnedData:info];
}
